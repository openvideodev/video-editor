    ...
    <TooltipProvider delayDuration={100}>
      <PromptInputContext.Provider value={contextValue}>
        <div
          ...
          className={cn(
            "relative flex h-auto w-full cursor-text flex-col gap-0 overflow-hidden rounded-md border border-border bg-card  dark:bg-input/30",
            className,
          )}
          onClick={handleClick}
          {...props}
...
function PromptInputAction({ asChild = false, tooltip, ...props }: PromptInputActionProps) {
